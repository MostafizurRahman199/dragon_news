...
import { FaRegBookmark, FaShareAlt, FaRegStar, FaRegEye } from 'react-icons/fa'
...
const CategoryCard = ({ news }) => {
  ...
  return (
    <div className="card border p-2 sm:p-4 mb-4">
      ...
      <Link 
        to={`/news/${_id}`} 
        className="text-yellow-500 text-sm sm:text-base hover:underline hover:font-semibold cursor-pointer mb-3 sm:mb-4"
      >
        See more
      </Link>
